...
const serve = (path, cache) =>
	app.register(ssr.resolveWWW(path), {
...
//app.register(require('fastify-static'), {root: ssr.resolveWWW('.')})
//TODO enabled cache on assets https://github.com/fastify/fastify-caching
app.use('/', serveStatic(ssr.resolveWWW('.')))
